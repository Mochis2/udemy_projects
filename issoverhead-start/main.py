...
MY_LAT = 47.519981  # Your latitude
MY_LONG = 8.935250  # Your longitude

MY_EMAIL = "morriseberhard11@gmail.com"
PASSWORD = os.environ.get("PW_FOR_EMAIL_PROGRAM_M11")
...
while True:
    ...
    if check_if_iss_is_near() and check_if_dark():
        ...
        with smtplib.SMTP("smtp.gmail.com") as connection:
            ...
            connection.sendmail(
                from_addr=MY_EMAIL,
                to_addrs="morriseberhard44@gmail.com",
                msg=
                "Subject:YO LOOK UP THE ISS IS IN THE SKY\n\nI HOPE IT ISN'T CLOUDY"
            )
